...
void Terra(int clientid)
{
	...
	int stone0 = GetFirstSlotSADD(clientid,5335,64);
	if(stone0 == -1 )
	{
		SendClientMsg(clientid,"É necessário a Pedra Terra Atribuir Status da Terra.");
		return;
	}
	if(player->Equip[11].Index == -1 )
	{
		SendClientMsg(clientid,"É necessário a Ordem da Terra Equipada.");
		return;
	}
	if(player->Inventory[1].Index = 5335 && player->Equip[0].EFV2 == 5 && player->Equip[11].Index == 6457)
	{
		...
		if(player->bStatus.Level > 50 && player->bStatus.Level < 60)
		{
			...
			player->Equip[15].Index = 796;
			player->Equip[15].EF1= 43;
			player->Equip[15].EFV1 = 0;
			player->Equip[15].EF2= 3;
			player->Equip[15].EFV2 = 35; // 35 Defesa
			player->Equip[15].EF3= 3;
			player->Equip[15].EFV3 = 35; // 35 Defesa
			player->Inventory[Ideal].Index = 0;
			player->Equip[11].Index = 0;
			LogForAll(clientid,"Personagem Atribuiu Status da Terra");
			sprintf(tmp,"[%s] Atribuiu Status da Terra. ",thisclient->Name);
		...
		else if(player->bStatus.Level > 61 && player->bStatus.Level < 91)
		{
			...
			player->Equip[15].EFV1 = 0;
			player->Equip[15].EF2= 3;
			player->Equip[15].EFV2 = 40; // 40 Defesa
			player->Equip[15].EF3= 3;
			player->Equip[15].EFV3 = 40; // 40 Defesa
			player->Inventory[Ideal].Index = 0;
			player->Equip[11].Index = 0;
			LogForAll(clientid,"Personagem Atribuiu Status da Terra");
			sprintf(tmp,"[%s] Atribuiu Status da Terra. ",thisclient->Name);
		...
		else if(player->bStatus.Level > 92 && player->bStatus.Level < 121)
		{
			...
			player->Equip[15].EFV1 = 0;
			player->Equip[15].EF2= 3;
			player->Equip[15].EFV2 = 50; // 50 Defesa
			player->Equip[15].EF3= 3;
			player->Equip[15].EFV3 = 50; // 50 Defesa
			player->Inventory[Ideal].Index = 0;
			player->Equip[11].Index = 0;
			LogForAll(clientid,"Personagem Atribuiu Status da Terra");
			sprintf(tmp,"[%s] Atribuiu Status da Terra. ",thisclient->Name);
		...
		else if(player->bStatus.Level == 149)
		{
			...
			player->Equip[15].EFV1 = 0;
			player->Equip[15].EF2= 3;
			player->Equip[15].EFV2 = 90; // 90 Defesa
			player->Equip[15].EF3= 3;
			player->Equip[15].EFV3 = 90; // 90 Defesa
			player->Inventory[Ideal].Index = 0;
			player->Equip[11].Index = 0;
			LogForAll(clientid,"Personagem Atribuiu Status da Terra");
			sprintf(tmp,"[%s] Atribuiu Status da Terra. ",thisclient->Name);
		...
		else if(player->bStatus.Level == 199)
		{
			...
			player->Equip[15].EFV1 = 0;
			player->Equip[15].EF2= 3;
			player->Equip[15].EFV2 = 127; // 127 Defesa
			player->Equip[15].EF3= 2;
			player->Equip[15].EFV3 = 127; // 127 Defesa
			player->Inventory[Ideal].Index = 0;
			player->Equip[11].Index = 0;
			LogForAll(clientid,"Personagem Atribuiu Status da Terra");
			sprintf(tmp,"[%s] Atribuiu Status da Terra. ",thisclient->Name);
